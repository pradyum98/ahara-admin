...
import { CouponDetails, GeneralInfoForm,MobileNumberVerificationForm } from "../components/Forms";
...
export default () => {
  ...
  const [couponLimit , setCouponLimit] = useState(20);
  ...
  return (
    <>
      ...
      <Row>
        {/* <Col xs={12} xl={8}> */}
            {!mobileNumberVerified && <MobileNumberVerificationForm  couponLimit = {couponLimit} onConfirmed = {(t) => setMobileNumberVerified(t)}/>}
            {mobileNumberVerified && <CouponDetails onConfirmed = {(t) => setMobileNumberVerified(t)}
            /> }
        {/* </Col> */}
