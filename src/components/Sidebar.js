...
import AharaLogo from "../assets/img/icons/Logo.png"
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Ahara Admin"  link={Routes.DashboardOverview.path} image={AharaLogo} />

              {/* <NavItem title="Overview" link={Routes.DashboardOverview.path} icon={faChartPie} />  */}
              <NavItem title="Transactions" icon={faHandHoldingUsd} link={Routes.Transactions.path} />
              <NavItem title="Vendors" icon={faFileAlt} link={Routes.Vendors.path} />
              <NavItem title="Monthly Sales" icon={faCog} link={Routes.MonthlySales.path} />
              <NavItem title="Monthly Vendor Payout" icon={faCog} link={Routes.MonthlyVendorPayout.path} />
              <NavItem title="Generate Coupons" icon={faBook} link={Routes.QRGenerator.path} />
